    ...
    <div className="p-4">
       ...
       {/* name */}
        ...
        <select className='bg-slate-200 p-1 my-1' id='category' name='category' onChange={handleOnChange} value={data.category}>
          ...
          <option value={"womensalon"}>Women's Salon, Spa & Laser Clinic</option>
          <option value={"mensalon"}>Men's Salon & Massage</option>
          <option value={"repair"}>AC & Application Repair</option>
          ...
          <option value={"Most book service"}>Most booked services</option>
